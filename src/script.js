...
$(document).ready(function() {
    ...
    rightArrow.on('click', () => {
        ...
        slider1.css('transform', `translate(calc(${leftWidthOne}px + ${rigthWidthOne}px + 20px))`);
        slider2.css('transform', `translate(calc(${leftWidthTwo}px + ${rigthWidthTwo}px - 160px + 20px))`);
    });
    ...
    slider1.on('transitionend', () => {
        ...
        slider1.css({
            transition: 'none',
            transform: `translate(calc(${childWidth}px + 10px))`,
        });
        setTimeout(() => {
    ...
    slider2.on('transitionend', () => {
        ...
        slider2.css({
            transition: 'none',
            transform: `translate(calc(${childWidth}px - 160px + 10px))`
        });
        setTimeout(() => {
